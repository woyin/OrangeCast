...
func TestParseJSONLoose_PlainJSON(t *testing.T) {
	raw := `{"title":"T","summary":"S","keyPoints":[],"chapters":[],"quotes":[],"tags":[],"suggestedQuestions":[]}`
	var c KnowledgeCard
...
func TestParseJSONLoose_StripsCodeBlock(t *testing.T) {
	...
	raw := "```json\n{\"title\":\"X\",\"summary\":\"\",\"keyPoints\":[],\"chapters\":[],\"quotes\":[],\"tags\":[],\"suggestedQuestions\":[]}\n```"
	var c KnowledgeCard
	if err := parseJSONLoose(raw, &c); err != nil {
...
func TestParseJSONLoose_StripsSurroundingNoise(t *testing.T) {
	...
	raw := `这是知识卡片：{"title":"Y","summary":"","keyPoints":[],"chapters":[],"quotes":[],"tags":[],"suggestedQuestions":[]} 希望对你有帮助`
	var c KnowledgeCard
	if err := parseJSONLoose(raw, &c); err != nil {
...
func TestParseJSONLoose_IgnoresUnknownField(t *testing.T) {
	...
	raw := `{"title":"Z","summary":"","keyPoints":[],"chapters":[],"quotes":[],"tags":[],"suggestedQuestions":[],"bogusField":1}`
	var c KnowledgeCard
	if err := parseJSONLoose(raw, &c); err != nil {
