...
func (sel *Selector) Bundle(activeProvider string) (*ProviderBundle, error) {
	...
	case "openai":
		...
		return &ProviderBundle{Transcription: oa, Analysis: oa, QA: oa, Writer: oa, Highlight: oa, Paraphrase: oa, StudyChat: oa, RefChecker: oa, Narration: sel.narration}, nil
	case "groq", "":
		if sel.groqAPIKey == "" {
		...
		return &ProviderBundle{Transcription: g, Analysis: g, QA: g, Writer: g, Highlight: g, Paraphrase: g, StudyChat: g, RefChecker: g, Narration: sel.narration}, nil
	default:
