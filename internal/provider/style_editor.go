...
func (g *GroqProvider) ReviewStyle(ctx context.Context, request StyleReviewRequest) (*StyleReviewResult, error) {
...
func (o *OpenAIProvider) ReviewStyle(ctx context.Context, request StyleReviewRequest) (*StyleReviewResult, error) {
	input, err := styleReviewInput(request)
	if err != nil {
		return nil, err
	}
